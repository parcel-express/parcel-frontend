...
const MessagePopup: React.FC<MessagePopupProps> = ({ isOpen, onClose }) => {
          ...
          <InputsBox>
            <DropdownContainer>
              <Dropdown
                ...
                variant='dropdown'
                onChange={() => {}}
                placeholder={tMessages('Popup.input1Placeholder')}
                label={''}
            ...
            <DropdownContainer>
              <Dropdown
                ...
                variant='input'
                onChange={() => {}}
                placeholder={tMessages('Popup.trackingPlaceholder')}
                label={tMessages('Popup.tracking')}
                inputPadding='12px 16px'
                items={[]}
              />
            </DropdownContainer>
            <DropdownContainer>
              <Dropdown
                ...
                variant='textarea'
                onChange={() => {}}
                placeholder={tMessages('Popup.messagePlaceholder')}
                label={tMessages('Popup.message')}
                inputPadding='12px 16px'
                items={[]}
              />
            </DropdownContainer>
