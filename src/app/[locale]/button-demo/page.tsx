    ...
    <Container>
      ...
      <Section>
        ...
        <SizeGrid>
          ...
          <Button variant="primary" size="md">MD Button</Button>
      ...
      <Section>
        ...
        <WhiteBodyMedium color="rgba(255, 255, 255, 0.9)">
          ✨ Hover: Subtle lift with enhanced shadows<br/>
          🎯 Click: Scale down (0.96-0.98) with faster transition<br/>
          💫 Ripple: Expanding circle effect on click<br/>
          🎨 Enhanced borders and shadows<br/>
